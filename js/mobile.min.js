        ...
        if (window.innerWidth <= 900) {
            ...
            if (imgElements) {
                ...
                for (let i = 0; i < h2Elements?.length; i++) {
                    ...
                    h2Elements[i].style.background = 'url("https://haumontructrang.phongkhamdakhoanhatviet.vn/images/icons/icon_cong.webp") no-repeat left center';
                ...
                for (let i = 0; i < h3Element.length; i++) {
                    ...
                    h3Element[i].style.background = 'url("https://haumontructrang.phongkhamdakhoanhatviet.vn/images/icons/icon_mui.gif") no-repeat left center';
